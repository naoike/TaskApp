...
public class InputActivity extends AppCompatActivity {
    ...
    private EditText mTitleEdit, mContentEdit,mCategoryEdit;  // 課題　カテゴリー
    private Task mTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCategoryEdit = (EditText) findViewById(R.id.category_edit_text);    // 課題　カテゴリー
        ...
        if (mTask == null) {
            ...
            // 更新の場合
            mCategoryEdit.setText(mTask.getCategory()); // 課題　カテゴリー
    ...
    private void addTask() {
        ...
        alarmManeger.set(AlarmManager.RTC_WAKEUP, calendar.getTimeInMillis(),resultPendingIntent);
